...
class EvaluationQuestionService(Service):
    ...
    def set_evaluation_question_state(self, evaluation_question_id: str, state: str, score: float):
        self.update(index=evaluation_question_id,
                    instruction={EvaluationQuestionDto.state: state, EvaluationQuestionDto.score: score})
